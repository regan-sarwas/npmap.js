...
var NpmapIcon = L.Icon.extend({
  ...
  statics: {
    MAKI_TEMPLATE: 'url(https://a.tiles.mapbox.com/v4/marker/pin-{{size}}+{{color}}{{retina}}.png?access_token=pk.eyJ1IjoibnBzIiwiYSI6IkdfeS1OY1UifQ.K8Qn5ojTw4RV1GwBlsci-Q)'
  },
